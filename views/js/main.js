  ...
  switch (y) {
    ...
    case "horror":
      var horror = ["murderer", "chainsaw", "knife", "sword", "murder", "devil", "killer", "psycho", "ghost", "monster",
        "godzilla", "werewolf", "vampire", "demon", "graveyard", "zombie", "mummy", "curse", "death", "grave", "tomb",
        "beast", "nightmare", "frankenstein", "specter", "poltergeist", "wraith", "corpse", "scream", "massacre",
        "cannibal", "skull", "bones", "undertaker", "zombie", "creature", "mask", "psychopath", "fiend", "satanist",
        "moon", "fullMoon"
      ];
      return horror;
    case "gross":
      var gross = ["slime", "bug", "roach", "fluid", "pus", "booger", "spit", "boil", "blister", "orifice", "secretion",
        "mucus", "phlegm", "centipede", "beetle", "fart", "snot", "crevice", "flatulence", "juice", "mold", "mildew",
    ...
    case "everyday":
      var everyday = ["mirror", "knife", "fork", "spork", "spoon", "tupperware", "minivan", "suburb", "lamp", "desk",
        "stereo", "television", "TV", "book", "car", "truck", "soda", "door", "video", "game", "computer", "calender",
    ...
    case "jewelry":
      var jewelry = ["earrings", "ring", "necklace", "pendant", "choker", "brooch", "bracelet", "cameo", "charm",
        "bauble", "trinket", "jewelry", "anklet", "bangle", "locket", "finery", "crown", "tiara", "blingBling", "chain",
        "rosary", "jewel", "gemstone", "beads", "armband", "pin", "costume", "ornament", "treasure"
      ];
      return jewelry;
    case "places":
      var places = ["swamp", "graveyard", "cemetery", "park", "building", "house", "river", "ocean", "sea", "field",
        "forest", "woods", "neighborhood", "city", "town", "suburb", "country", "meadow", "cliffs", "lake", "stream",
    ...
    case "scifi":
      var scifi = ["robot", "alien", "raygun", "spaceship", "UFO", "rocket", "phaser", "astronaut", "spaceman",
        "planet", "star", "galaxy", "computer", "future", "timeMachine", "wormHole", "timeTraveler", "scientist",
        "invention", "martian", "pluto", "jupiter", "saturn", "mars", "quasar", "blackHole", "warpDrive", "laser",
        "orbit", "gears", "molecule", "electron", "neutrino", "proton", "experiment", "photon", "apparatus", "universe",
...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    var randomPizzaContainer = document.getElementsByClassName("randomPizzaContainer"),
        len = randomPizzaContainer.length,
        newwidth;
    switch (size) {
      case '1':
        newwidth = 25;
...
//Move get element outside of loop.
...
function updatePositions() {
  ...
  // Create top and phase outside of loop.
  var phase = [],
      top = document.body.scrollTop / 1250;
  for (var i = 0; i < 5; i++) {
    phase[i] = Math.sin(top + (i % 5));
  }
  //Use Web API instead of document.queryall
  var items = document.getElementsByClassName('mover'),
      itemslen = items.length,
      phase_item;
  for (var i = 0; i < itemslen; i++) {
    phase_item = phase[i % 5];
    items[i].style.left = items[i].basicLeft + 100 * phase_item + 'px';
  }
...
document.addEventListener('DOMContentLoaded', function() {
  // move elem and movingPizzas1 declaration outside of loop
  var cols = 8;
  var s = 256;
  var elem,
  ...
  // which becomes 25
  var size = window.screen.height,
      rows = Math.ceil(size / s);
